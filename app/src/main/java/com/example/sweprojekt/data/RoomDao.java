...
public interface RoomDao {
    ...
    //@Query("Select rcRoom.* from rcRoom join rcBuilding on rcRoom.building_id = rcBuilding.id where rcBuilding.building_prefix = :buildingPrefix and rcRoom.room_number= :roomNumber Limit 1")
